...
- [ ] Ingest only supported text or Markdown evidence from an approved source.
...
- [ ] Review and approve current-state workflow, Human / Software / AI allocation, target-state
      workflow, deterministic economics, and implementation specification in that order.
