# AI-FDE Documentation

## Product

- [Product vision](product/vision.md)
- [V1 product requirements](product/prd.md)
- [FDE doctrine](principles/fde-doctrine.md)

## Architecture

- [System architecture](architecture/system-architecture.md)
- [Domain model](architecture/domain-model.md)
- [Company Operating Model schema](architecture/company-operating-model.md)
- [Repository structure](architecture/repository-structure.md)

## Method

- [FDE lifecycle](methodology/fde-lifecycle.md)
...
- [Controlled design-partner production operations](runbooks/design-partner-production-operations.md)
- [Isolated database restore drill](runbooks/isolated-restore-drill.md)
- [Secret rotation and revocation](runbooks/secret-rotation-and-revocation.md)
- [Production qualification evidence records](runbooks/qualification-evidence-records.md)
